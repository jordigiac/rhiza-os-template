...
description: |
  ...
  tidy single-track arcs, flat escalation, no mixed feelings, linear time.
license: MIT
metadata:
  version: "2.9.1-rhiza.1"
...
0. For anything longer than a short caption, read `references/structural-tells.md` and run the structural pass first — shape decisions (where to start, whether to state the takeaway, how intensity moves) determine sentences, not the other way around. Style-editing a structurally AI-shaped piece leaves it detectably AI-shaped.
