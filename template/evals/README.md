...
2. **Custom exams** — every automation and custom skill gets its own folder
   ...
   define what done looks like, and dated scorecards. Created whenever a
   build is created; they are the graduation exams of the trust ladder.
   Nothing moves from beta to automated without passing its exam consistently.
...
the datasets and scorecards are this business's records, and they stay in
this OS.
